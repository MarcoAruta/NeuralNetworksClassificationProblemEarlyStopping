function [X_TrainingSet, T_TrainingSet, X_ValidationSet, T_ValidationSet, X_TestSet, T_TestSet] = load_dataset()
    ...
    %60000 immagini di dimensione 28x28
    ...
    %trasformo le etichette del training set in codifica binaria
    ...
    %trasformo le etichette del validation set in codifca binaria
    ...
    %10000 immagini di dimensione 28x28
