33% numNeurons è un vettore che contiene nella prima cella il numero di
...
% il numero di nodi dello strato i-1. funAttivazioni è un array in cui ogni
% elemento i è un numero che codifica una funzione di attivazione che verrà
...
B=cell(1,len);
%A(i) è la matrice dei valori di attivazione dei nodi dell'i-esimo strato
A=cell(1,len);
